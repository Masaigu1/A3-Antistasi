...
["vehiclesPlanesAA", ["RHS_Su25SM_vvs","rhs_mig29s_vvs","rhs_mig29sm_vvs","RHS_T50_vvs_generic","RHS_T50_vvs_generic_ext"]] call _fnc_saveToTemplate; 			//this line determines air supperiority planes -- Example: ["vehiclesPlanesAA", ["B_Plane_Fighter_01_F"]] -- Array, can contain multiple assets
...
["staticAT", ["rhs_Kornet_9M133_2_msv","rhs_Kornet_9M133_2_msv"]] call _fnc_saveToTemplate; 					//this line determinesstatic ATs -- Example: ["staticAT", ["B_static_AT_F"]] -- Array, can contain multiple assets
...
_loadoutData setVariable ["rifles", [["rhs_weap_ak74m","rhs_acc_dtk","rhs_acc_perst1ik","rhs_acc_1p78",[],[],""],["rhs_weap_ak74m","rhs_acc_dtk","rhs_acc_perst1ik","rhs_acc_1p29",[],[],""],["rhs_weap_ak74m","rhs_acc_dtk","rhs_acc_perst1ik","",[],[],""]]]; 					//this line determines rifles -- Example: ["arifle_MX_F","arifle_MX_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["carbines", [["rhs_weap_aks74un","rhs_acc_pgs64_74un","","",[],[],""]]]; 					//this line determines carbines -- Example: ["arifle_MXC_F","arifle_MXC_Holo_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["grenadeLaunchers", [["rhs_weap_ak74m_gp25","rhs_acc_dtk","","",[],[],""]]]; 			//this line determines grenade launchers -- Example: ["arifle_MX_GL_ACO_F","arifle_MX_GL_ACO_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["SMGs", [["rhs_weap_pp2000","","","",[],[],""]]]; 						//this line determines SMGs -- Example: ["SMG_01_F","SMG_01_Holo_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["machineGuns", [["rhs_weap_pkm","","","",[],[],""],["rhs_weap_pkp","","","",[],[],""],["rhs_weap_pkp","","","rhs_acc_1p29",[],[],""]]]; 				//this line determines machine guns -- Example: ["arifle_MX_SW_F","arifle_MX_SW_Hamr_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["marksmanRifles", [["rhs_weap_svds","","","rhs_acc_pso1m2",[],[],""]]]; 			//this line determines markman rifles -- Example: ["arifle_MXM_F","arifle_MXM_Hamr_pointer_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["sniperRifles", [["rhs_weap_svdp","rhs_acc_tgpv2","","rhs_acc_pso1m2",[],[],""]]]; 				//this line determines sniper rifles -- Example: ["srifle_LRR_camo_F","srifle_LRR_camo_SOS_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["lightATLaunchers", [["rhs_weap_rpg26","","","",[],[],""]]]; 			//this line determines light AT launchers -- Example: ["launch_NLAW_F"] -- Array, can contain multiple assets
_loadoutData setVariable ["ATLaunchers", [["rhs_weap_rpg7","","","rhs_acc_pgo7v3",[],[],""]]]; 				//this line determines light AT launchers -- Example: ["launch_NLAW_F"] -- Array, can contain multiple assets
...
_loadoutData setVariable ["sidearms", [["rhs_weap_6p53","","","",[],[],""],["rhs_weap_pya","","","",[],[],""],["rhs_weap_pp2000_folded","","","",[],[],""]]]; 					//this line determines handguns/sidearms -- Example: ["hgun_Pistol_heavy_01_F", "hgun_P07_F"] -- Array, can contain multiple assets
...
_loadoutData setVariable ["smokeGrenades", [["rhs_mag_rdg2_white"]]]; 			//this line determines smoke grenades -- Example: ["SmokeShell", "SmokeShellRed"] -- Array, can contain multiple assets
